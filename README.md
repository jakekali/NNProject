...
The data was obtained from one of the sample datasets avaible through Google Colab. I performed some manipulations using pandas, in colab, to normalize the data by dividing by 255, and to hot encode an output vector the output.  <br />
